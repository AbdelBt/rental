      ...
      {!isMobile && (
        ...
        >
          ...
          <div className="py-5 px-4 border-b border-white/[0.06] flex items-center justify-between gap-2">
            {!collapsed && (
              <div>
                <div className="font-playfair text-lg font-bold text-gold whitespace-nowrap">DRIVO</div>
                <div className="text-[10px] text-cream/35 tracking-widest uppercase">Espace client</div>
              </div>
            )}
            <button
        ...
        <div className="fixed inset-0 z-[300] flex">
          ...
          <aside className="relative w-[260px] bg-dark-bg h-screen flex flex-col border-r border-white/[0.08] z-10">
            <div className="py-5 px-4 border-b border-white/[0.06] flex justify-between items-center">
              <div className="font-playfair text-xl font-bold text-gold">DRIVO</div>
              <button
            ...
            {client && (
              <div className="p-4 border-b border-white/[0.06] flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-cream/40">{client.email}</div>
                </div>
              </div>
            )}
            ...
            <div className="text-[13px] text-cream/40">
              {NAV.find(
                (n) =>
                  ...
                  (n.path !== "/client/dashboard" && location.pathname.startsWith(n.path)),
              )?.label || "Mon espace"}
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            {client && (
              <div className="flex items-center gap-2 bg-white/[0.04] border border-white/[0.08] rounded-lg py-1.5 px-3">
                ...
                {!isMobile && (
                  <span className="text-xs font-semibold">{client.first_name}</span>
                )}
              </div>
            )}
          </div>
