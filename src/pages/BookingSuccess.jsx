        ...
        {loading ? (
          ...
          <>
              ...
              <>
                ...
                <div className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-5 mb-4 space-y-3">
                  ...
                  <div className="flex justify-between text-[13px]">
                    ...
                    <span className="font-semibold">
                      {data.days} jour{Number(data.days) > 1 ? "s" : ""}
                    </span>
                  </div>
                  {data.deliveryCity && (
                    <div className="flex justify-between text-[13px]">
                ...
                <div className="bg-gold/[0.07] border border-gold/20 rounded-2xl p-5 mb-6">
                  ...
                  <div className="flex justify-between text-[13px] mb-3">
                    ...
                    <span className="font-bold text-green-400">
                      ✓ {Number(data.amountPaid).toLocaleString("fr-FR")} €
                    </span>
                  </div>
            ...
            <div className="flex flex-col gap-3">
              <Link
                to="/client/dashboard"
                className="btn-primary py-3.5 text-sm text-center no-underline"
              >
                Mon espace client →
              </Link>
              <Link
                to="/cars"
                className="py-3.5 text-sm text-center text-cream/50 hover:text-cream transition-colors no-underline"
              >
